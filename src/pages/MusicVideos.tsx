    ...
    <div>
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={pkg.title} className="panel rounded-2xl p-5">
      ...
      <Section size="lg" tone="borderTop" padClassName="py-12 md:py-16">
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-mono text-2xl text-[var(--text)]">Selected videos</h2>
            ...
            <FAQAccordion
              items={[
                ...
                },
                {
                  question: 'Timelines',
                  answer:
                    'Typical timeline: 1 week pre-pro, 1–2 shoot days, first edit in 7 days, final delivery in 12–15 days.'
                },
                {
