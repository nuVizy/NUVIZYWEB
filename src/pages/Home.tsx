    ...
    <div>
          ...
          <div className="grid grid-cols-12 gap-8 items-end">
            <header className="col-span-12 lg:col-span-7">
              ...
              <p className="mt-3 text-sm text-[var(--muted)] max-w-2xl">
                UK-built, now based in Paphos, Cyprus — working across Europe with artists, brands, labels and stages.
              </p>
              ...
              <div className="panel rounded-2xl p-6">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3 text-sm">
                  {[
                    ...
                    <TextLink key={item.to} to={item.to} className="justify-between">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4 text-sm">
                  <div className="border border-[var(--accent-dim)] rounded-xl p-4">
      ...
      <Section tone="borderTop" size="lg" padClassName="py-12 md:py-16">
        <SectionHeading
          ...
          description="Not a menu — a set of modules you can re-use across campaigns, releases, tours and platforms."
        />
        <div className="mt-8">
          <ServicesStrip
            services={[
      ...
      <Section size="lg" padClassName="py-12 md:py-16" tone="borderTop">
        <SectionHeading
          ...
          description="Replace the placeholders below with your real clients/collaborators when ready. This section helps trust and improves search relevance." 
        />

        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm text-[var(--muted)]">
          {["Festival / Theatre", "Label / Artist", "Brand / Studio", "Agency / Producer"].map((name) => (
            <div key={name} className="border border-[var(--accent-dim)] rounded-xl px-4 py-3">
              {name}
            </div>
          ))}
        </div>
